...
{
    public class MatrixSample : Sample
    {
        ...
        public MatrixSample() : base(null, new CustomizedEngine.CustomizedEngine(null, new MatrixSampleFilterShader()))
        {
    ...
    {
        private MatrixSample _sample;

        public EventCallback(MatrixSample sample)
        {
            _sample = sample;
        }
        ...
        public override void OnTrigger(TriggerPair[] pairs)
        {
            ...
            foreach (var pair in pairs)
            {
                if (pair.TriggerActor != null && pair.OtherActor != null)
                {
                    ...
                    Debug.WriteLine($"pair.TriggerActor == MatrixSample._ballBody = {pair.TriggerActor == MatrixSample._ballBody }");
                    Debug.WriteLine($"pair.OtherActor == MatrixSample._largeBallBody = {pair.OtherActor == MatrixSample._largeBallBody}");

                    Debug.WriteLine($"pair.TriggerActor == MatrixSample._largeBallBody = {pair.TriggerActor == MatrixSample._largeBallBody }");
                    Debug.WriteLine($"pair.OtherActor == MatrixSample._ballBody = {pair.OtherActor == MatrixSample._ballBody}");
                }
            }
        }
    }
